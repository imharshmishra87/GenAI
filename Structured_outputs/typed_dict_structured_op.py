...
class Check(TypedDict):
    summary:Annotated[str,"I want you to summarize the entire Review"]
    sentiment:Annotated[str,"The sentiment can either be Positive , Negative or Neutral"]
    points: Annotated[list[str],"Give me a list of major points discussed inside this review"]
    pros:Annotated[Optional[str],"List of all the pros"]
    cons:Annotated[Optional[str],"List of all the cons"]

...
class Check(BaseModel):
    summary:Annotated[str,Field(description="I want you to summarize the entire Review")]

    sentiment:Annotated[str,Field(description="The sentiment can either be Positive , Negative or Neutral"),Literal["Positive","negative","Neutral"]]

    points: Annotated[list[str],Field(description="Give me a list of major points discussed inside this review")]
    pros:Annotated[Optional[str],Field(description="List of all the pros",default=None)]
    cons:Annotated[Optional[str],Field(description="List of all the cons",default=None)]


structured_op=model.with_structured_output(Check)
